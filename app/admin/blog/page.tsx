...
function AdminBlogContent() {
  ...
  const handleSave = async () => {
    try {
      console.log('[AdminBlog] Saving changes...')
      await saveOverrides()
      await reloadOverrides()
      console.log('[AdminBlog] ✅ All changes saved and reloaded!')
      toast({
        title: "Saved!",
...
function HeroSection() {
  ...
  const [ourBlog, setOurBlog] = useState(t("blog.ourBlog"))
  const [blog, setBlog] = useState(t("blog.blog"))

  useEffect(() => {
    setIsVisible(true)
    setOurBlog(t("blog.ourBlog"))
    setBlog(t("blog.blog"))
  }, [t])
